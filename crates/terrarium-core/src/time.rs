...
impl Duration { pub const fn seconds(n:u64)->Self{Self(n)} pub const fn minutes(n:u64)->Self{Self(n*60)} pub const fn hours(n:u64)->Self{Self(n*3600)} pub const fn days(n:u64)->Self{Self(n*86400)} }
